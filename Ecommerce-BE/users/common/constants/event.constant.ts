...
export const getStoreExist = 'get::store:exist'
...
export const getProductOderByOrderId = 'get::product::order::by::order::id'

export const checkRated = 'check::rated'

export const updateRatedStore = 'update::rated::store'
...
export const statusOfTransaction = 'status::of::transaction'
